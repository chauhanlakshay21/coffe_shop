                                      ...
                                      Container(
                                        ...
                                        child: Padding(
                                          ...
                                          child: Column(
                                            mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                            children: [
                                              const Icon(Icons.water_drop_rounded, color: Colors.orange),
                                              Text(
                                                "Milk",
                                                style: TextStyle(color: Colors.white.withOpacity(.5)),
                                              )
                ...
                child: SingleChildScrollView(
                  child: Column(
                    ...
                    children: [
                              ...
                              child: InkWell(
                                ...
                                child: Container(
                                  ...
                                  decoration: BoxDecoration(
                                    ...
                                    borderRadius: BorderRadius.circular(10),
                                    border: Border(
                                      right: BorderSide(color: s ? Colors.orange : Colors.black),
                                      left: BorderSide(color: s ? Colors.orange : Colors.black),
                                      top: BorderSide(color: s ? Colors.orange : Colors.black),
                                      bottom: BorderSide(color: s ? Colors.orange : Colors.black),
                                    ),
                                  ),
                                  child: Center(
                                    child: Text(
                              ...
                              child: InkWell(
                                ...
                                child: Container(
                                  ...
                                  decoration: BoxDecoration(
                                    ...
                                    borderRadius: BorderRadius.circular(10),
                                    border: Border(
                                      right: BorderSide(color: m ? Colors.orange : Colors.black),
                                      left: BorderSide(color: m ? Colors.orange : Colors.black),
                                      top: BorderSide(color: m ? Colors.orange : Colors.black),
                                      bottom: BorderSide(color: m ? Colors.orange : Colors.black),
                                    ),
                                  ),
                                  child: Center(
                                    child: Text(
                              ...
                              child: InkWell(
                                ...
                                child: Container(
                                  ...
                                  decoration: BoxDecoration(
                                    ...
                                    borderRadius: BorderRadius.circular(10),
                                    border: Border(
                                      right: BorderSide(color: l ? Colors.orange : Colors.black),
                                      left: BorderSide(color: l ? Colors.orange : Colors.black),
                                      top: BorderSide(color: l ? Colors.orange : Colors.black),
                                      bottom: BorderSide(color: l ? Colors.orange : Colors.black),
                                    ),
                                  ),
                                  child: Center(
                                    child: Text(
                      ...
                      const SizedBox(height: 20), // Add padding at the bottom for better scrolling
                    ],
                  ),
                ),
              ),
